...
export class Token extends ethereum.SmartContract {
  ...
  getTokenIdOfUUID(uuid: string): BigInt {
    let result = super.call(
      "getTokenIdOfUUID",
      "getTokenIdOfUUID(string):(uint256)",
      [ethereum.Value.fromString(uuid)]
    );

    return result[0].toBigInt();
  }

  try_getTokenIdOfUUID(uuid: string): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getTokenIdOfUUID",
      "getTokenIdOfUUID(string):(uint256)",
      [ethereum.Value.fromString(uuid)]
  ...
  getUUIDOfTokenId(tokenId: BigInt): string {
    let result = super.call(
      "getUUIDOfTokenId",
      "getUUIDOfTokenId(uint256):(string)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    );
  ...
  try_getUUIDOfTokenId(tokenId: BigInt): ethereum.CallResult<string> {
    let result = super.tryCall(
      "getUUIDOfTokenId",
      "getUUIDOfTokenId(uint256):(string)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
  ...
  proxyMinter(): Address {
    let result = super.call("proxyMinter", "proxyMinter():(address)", []);

    return result[0].toAddress();
  }

  try_proxyMinter(): ethereum.CallResult<Address> {
    let result = super.tryCall("proxyMinter", "proxyMinter():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class ClearTokenURICall extends ethereum.Call {
  get inputs(): ClearTokenURICall__Inputs {
    return new ClearTokenURICall__Inputs(this);
  }

  get outputs(): ClearTokenURICall__Outputs {
    return new ClearTokenURICall__Outputs(this);
  }
}

export class ClearTokenURICall__Inputs {
  _call: ClearTokenURICall;

  constructor(call: ClearTokenURICall) {
    this._call = call;
  }
...
export class ClearTokenURICall__Outputs {
  _call: ClearTokenURICall;
...
export class SetProxyMinterCall extends ethereum.Call {
  get inputs(): SetProxyMinterCall__Inputs {
    return new SetProxyMinterCall__Inputs(this);
  }

  get outputs(): SetProxyMinterCall__Outputs {
    return new SetProxyMinterCall__Outputs(this);
  }
}

export class SetProxyMinterCall__Inputs {
  _call: SetProxyMinterCall;

  constructor(call: SetProxyMinterCall) {
    this._call = call;
  }
...
export class SetProxyMinterCall__Outputs {
  _call: SetProxyMinterCall;
